...
@Component({
  selector: 'app-define-reward',
  templateUrl: './define-reward.component.html',
  styleUrls: ['./define-reward.component.scss']
})
export class DefineRewardComponent implements OnInit {
