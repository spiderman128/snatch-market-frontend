...
@Component({
  selector: 'app-manage-redeem-reward',
  templateUrl: './manage-redeem-reward.component.html',
  styleUrls: ['./manage-redeem-reward.component.scss']
})
export class ManageRedeemRewardComponent implements OnInit {
  ...
  onRedeemClick() {
    this.router.navigate(['/dashboard/manage-redeem-now']);
  } 
