...
@Component({
  selector: 'app-manage-list-reward',
  templateUrl: './manage-list-reward.component.html',
  styleUrls: ['./manage-list-reward.component.scss']
})
export class ManageListRewardComponent implements OnInit {
